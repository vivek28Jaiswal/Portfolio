...
export function GridBackgroundDemo() {
  return (
    <div className="h-[50rem] w-full dark:bg-black bg-white  dark:scale-[1.5] dark:bg-grid-white/[0.05] bg-grid-black/[0.1] relative flex items-center justify-center">
...
export function GridSmallBackgroundDemo() {
  return (
    (<div
      className="h-[50rem] w-full dark:bg-black bg-white  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.1] relative flex items-center justify-center">
      {/* Radial gradient for the container to give a faded look */}
      <div
