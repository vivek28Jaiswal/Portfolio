...
export function GridBackgroundDemo() {
  return (
    <div className="h-[50rem] w-full dark:bg-black bg-white  dark:scale-[1.5] dark:bg-grid-white/[0.04] bg-grid-black/[0.1] relative flex items-center justify-center">
